...
/**
 * Servlet implementation class pagarPedidoTarjeta
 */
@WebServlet("/pagarPedidoTarjeta")
public class pagarPedidoTarjeta extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public pagarPedidoTarjeta() {
        super();
...
HttpSession session = request.getSession();
	    ...
	    pedidoDAO.actualizarPedido(pedidoId, "Tarjeta", numFactura, totalPago);
